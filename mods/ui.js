...
function setupVideoPlayerObserver() {
  // Only enhance videos on movie/watch pages — applying full-screen
  // black overlays to video containers on other pages (homepage, search,
  // category) breaks the site and causes a black screen on Tizen TVs.
